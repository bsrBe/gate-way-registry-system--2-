...
export const AppProvider = ({ children }) => {
  ...
  const fetchUsersData = async () => {
    try {
      const response = await axios.get("https://https://grs-gbeb.onrender.com/api/users/list");
  ...
  const deleteUser = async id => {
    try {
      if (window.confirm("Are you Sure You To Delete This Item??")) {
        await axios.delete(`https://https://grs-gbeb.onrender.com/api/users/list/${id}`);
        fetchUsersData();
  ...
  const fetchVisitorsData = async () => {
    try {
      const response = await axios.get("https://https://grs-gbeb.onrender.com/api/visitors");
  ...
  const editVisitorData = async (id, editData) => {
    try {
      await axios.patch(`https:/https://grs-gbeb.onrender.com/api/visitors/${id}`, editData, {
        headers: {
  ...
  const deleteVisitorData = async id => {
    try {
      if (window.confirm("Are you Sure You To Delete This Item??")) {
        await axios.delete(`https://https://grs-gbeb.onrender.com/api/visitors/${id}`);
        fetchVisitorsData();
  ...
  const fetchWeaponsControllerData = async () => {
    try {
      const response = await axios.get("https://https://grs-gbeb.onrender.com/api/weapons/weaponcontroller");
  ...
  const updateWeaponStatus = async (itemId, updatedData) => {
    try {
      await axios.patch(`https://https://grs-gbeb.onrender.com/api/weapons/${itemId}`, updatedData, {
        headers: {
          "Content-Type": "application/json"
        }
      });
  ...
  const editWeaponsData = async (id, editData) => {
    try {
      await axios.patch(`https://https://grs-gbeb.onrender.com/api/weapons/${id}`, editData, {
        headers: {
          "Content-Type": "application/json"
        }
      });
  ...
  const deleteWeaponsData = async id => {
    try {
      if (window.confirm("Are you Sure You To Delete This Item??")) {
        await axios.delete(`https:/https://grs-gbeb.onrender.com/api/weapons/${id}`);
        fetchWeaponsData();
  ...
  const fetchVehiclesData = async () => {
    try {
      const response = await axios.get("https://https://grs-gbeb.onrender.com/api/vehicles");
  ...
  const deleteVehicleData = async id => {
    try {
      if (window.confirm("Are you Sure You To Delete This Item??")) {
        await axios.delete(`https://https://grs-gbeb.onrender.com/api/vehicles/${id}`);
        fetchVehiclesData();
  ...
  const editVehiclesData = async (id, editData) => {
    try {
      await axios.patch(`https://https://grs-gbeb.onrender.com/api/vehicles/${id}`, editData, {
        headers: {
          "Content-Type": "application/json"
        }
      });
